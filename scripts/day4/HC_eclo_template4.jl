...
function main_HC()
    ...
    anim = @animate for it = 1:nt
        ...
        for iter = 1:niter
            ...
            # (4) Compute flux qρT (as function of Darcy flux)

            # (5): Residual 

            # (5.5): set Rρ to 0 is x is smaller than wini
            # This will fix the pressure in the domain located on the west side
